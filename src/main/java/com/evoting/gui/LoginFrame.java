...
public class LoginFrame extends javax.swing.JFrame {
    ...
    public LoginFrame() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("com.evoting.i18n.messages");
    }
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        User existing = MongoService.getUserByUsername(username);
        if (existing != null) {
            if (!PasswordHasher.checkPassword(password, existing.getHashedPassword())) {
                JOptionPane.showMessageDialog(this, "Password salah!");
                return;
            }
            if (existing.isHasVoted()) {
                JOptionPane.showMessageDialog(this, "Kamu sudah voting!");
                return;
            }
        } else {
            // Register user baru
            String hashed = PasswordHasher.hashPassword(password);
            existing = new User(username, hashed);
            MongoService.saveUser(existing);
        }

        new VotingFrame(existing).setVisible(true);
        this.dispose();
